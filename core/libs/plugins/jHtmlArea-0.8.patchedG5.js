    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        init: function (elem, options) {
            if (elem.nodeName.toLowerCase() === "textarea") {
                ...
                // ===== G5 patch start ===== //
                // find the height/width for hidden
                ...
                var iframe = this.iframe = $("<iframe/>").height(taHeight);
                // iframe.width(textarea.width());
                iframe.width(taWidth - ($.browser.msie ? 0 : 4));
                // ===== G5 patch end ===== //
                ...
                // ===== G5 patch start ===== //
                // making the toolbar 2px narrower to account for borders (?)
