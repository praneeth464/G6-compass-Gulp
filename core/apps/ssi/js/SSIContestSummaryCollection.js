...
SSIContestModel,
SSIContestSummaryCollection:true
*/
SSIContestSummaryCollection = Backbone.Collection.extend({
    ...
    initialize: function () {
        'use strict';
        this.url = G5.props.URL_JSON_CONTEST_SUMMARY_HISTORY;
    },
